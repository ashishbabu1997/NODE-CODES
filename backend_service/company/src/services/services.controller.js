...
exports.getServices = function (req, res) {
    var body = req.params;
    services_manager_1.fetchCompanyServices(body).then(function (response) { return response_1["default"](res, response.code, 1, response.message, response.data); })["catch"](function (error) { return response_1["default"](res, error.code, 0, error.message, error.data); });
};

export default {
    getProfiles: 'SELECT company_profile_url as "profileUrl",company_description as "description",company_logo as "logo",company_cover_page as "coverPage",company_tagline as "tagline",company_linkedin_id as "linkedinId" FROM company WHERE company_id = $1',

...
exports.addEmployee = exports.getEmployee = void 0;
var employee_manager_1 = require("./employee.manager");
var response_1 = require("../common/response/response");
exports.getEmployee = function (req, res) {
    var body = req.query;
    employee_manager_1.getEmployeesByCompanyId(body).then(function (response) { return response_1["default"](res, response.code, 1, response.message, response.data); })["catch"](function (error) { return response_1["default"](res, error.code, 0, error.message, error.data); });
};

export default {
    ...
    addSubUser: "INSERT INTO employee(firstname, lastname, company_id, email, role_id, created_on, updated_on, status, user_role_id, account_type, created_by, updated_by,admin_approve_status,password) VALUES ($1, $2, $3, $4, $5, $6, $6, $7, $8,(select account_type from employee where employee_id=$9),$9,$9,$10,$11)",

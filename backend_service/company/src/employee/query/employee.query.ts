export default {
    ...
    addSubUser: "INSERT INTO employee(firstname, lastname, company_id, email, role_id, created_on, updated_on, status, user_role_id, account_type, created_by, updated_by,admin_approve_status,password) VALUES ($1, $2, $3, $4, $5, $6, $6, $7, $8,$9,$10,$10,$11,$12)",
    updateEmployee: "UPDATE employee SET firstname=$2, lastname=$3, role_id=$4, contact_number=$5, updated_on=$6, updated_by=$7,email=$8 WHERE employee_id = $1",    deleteEmployee: "UPDATE employee SET status=false WHERE employee_id=$1",

export default {
    getCompanyLocations: `SELECT company_location_id as "locationId",street_address_1 as "streetAddress1",street_address_2 as "streetAddress2",zipcode as "zipCode",city as "city",state_id as "stateId",country_id as "countryId" FROM company_locations WHERE company_id = $1 AND status  = true`,

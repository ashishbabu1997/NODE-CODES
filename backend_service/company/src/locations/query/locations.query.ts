export default {
    ...
    updateCompanyLocations: "UPDATE company_locations SET street_address_1=$1,street_address_2=$2,zipcode=$3,city=$4,state_id=$5,country_id = $6 WHERE company_location_id=$7 AND status = true",

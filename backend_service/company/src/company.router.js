...
var profilePercentage_route_1 = require("./profilePercentage/profilePercentage.route");
var personalProfile_route_1 = require("./personalProfile/personalProfile.route");
...
router
    ...
    .use("/api/" + config_1["default"].version + "/company/profilePercentage", profilePercentage_route_1["default"])
    .use("/api/" + config_1["default"].version + "/company/personalProfile", personalProfile_route_1["default"]);

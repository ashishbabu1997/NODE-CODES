                                ...
                                client.query(addHiringStepQuery, (err, res) => {
                                    ...
                                    client.query(query, (err, res) => {
                                        ...
                                        client.query('COMMIT', err => {
                                            ...
                                            var textFormat = config.text.firstLine + config.nextLine + config.text.secondLine + config.nextLine+config.text.thirdLine + config.nextLine + config.text.name.fontsize(3).bold() + config.colon + Name+ config.nextLine + config.text.companyName.fontsize(3).bold()+config.colon+companyName+config.nextLine+config.text.email.fontsize(3).bold()+config.colon+emailAddress+config.nextLine+config.text.phone.fontsize(3).bold()+config.colon+number + config.nextLine+config.text.fifthLine

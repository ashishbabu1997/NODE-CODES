...
export const updateProviderCandidateDetails = (_body) => {
    return {
        ...
        values:[_body.candidateId,_body.firstName,_body.lastName,_body.phoneNumber,_body.email,currentTime(),_body.employeeId,_body.candidatePositionName,_body.companyId,_body.jobCategoryId,4,_body.locationName],
    }
}

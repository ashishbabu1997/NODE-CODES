...
export const listFreeCandidates = (req, res) => {
  const body = req;
  candidateManager
    .listFreeCandidatesDetails(body)
    .then((response: any) => sendResponse(res, response.code, 1, 200, response.message, response.data))
    .catch((error: any) => sendResponse(res, error.code, 0, 400, error.message, error.data));
};
...
export const listForAddFromListCandidates = (req, res) => {
  const body = req;
  candidateManager
    .listAddFromListCandidates(body)
    .then((response: any) => sendResponse(res, response.code, 1, 200, response.message, response.data))
    .catch((error: any) => sendResponse(res, error.code, 0, 400, error.message, error.data));
};
...
export const candidateReview = (req, res) => {
  const body = req.body;
  candidateManager
    .addCandidateReview(body)
    .then((response: any) => sendResponse(res, response.code, 1, 201, response.message, response.data))
...
export const deleteCandidateFromPosition = (req, res) => {
  const body = req.body;
  candidateManager
    .removeCandidateFromPosition(body)
    .then((response: any) => {
...
export const addCandidateToPosition = (req, res) => {
  const body = req.body;
  candidateManager
    .linkCandidateWithPosition(body)
    .then((response: any) => sendResponse(res, response.code, 1, 201, response.message, response.data))
    .catch((error: any) => sendResponse(res, error.code, 0, 401, error.message, error.data));
};
...
export const updateLanguageProficiency = (req, res) => {
  const body = req.body;
  candidateManager
    .modifyLanguageProficiency(body)
    .then((response: any) => {
...
export const updateAvailability = (req, res) => {
  const body = req.body;
  candidateManager
    .modifyCandidateAvailability(body)
    .then((response: any) => {
      sendResponse(res, response.code, 1, 201, response.message, response.data);
    })
    .catch((error) => {
...
export const updateWorkExperience = (req, res) => {
  const body = req.body;
  candidateManager
    .modifyCandidateWorkHistory(body)
    .then((response: any) => {
      sendResponse(res, response.code, 1, 201, response.message, response.data);
    })
    .catch((error) => {
...
export const getAssesments = (req, res) => {
  const body = req.query;
  candidateManager
    .getCandidateAssesmentDetails(body)
    .then((response: any) => sendResponse(res, response.code, 1, 200, response.message, response.data))
    .catch((error: any) => sendResponse(res, error.code, 0, 400, error.message, error.data));
};
...
export const changeEllowRecruitmentStage = (req, res) => {
  const body = req.body;
  candidateManager
    .changeEllowRecruitmentStage(body)
    .then((response: any) => sendResponse(res, response.code, 1, 200, response.message, response.data))
    .catch((error: any) => sendResponse(res, error.code, 0, 400, error.message, error.data));
};
...
export const rejectFromCandidateEllowRecruitment = (req, res) => {
  const body = req.body;
  candidateManager
    .rejectFromCandidateEllowRecruitment(body)
    .then((response: any) => sendResponse(res, response.code, 1, 200, response.message, response.data))
    .catch((error: any) => sendResponse(res, error.code, 0, 400, error.message, error.data));
};
...
export const getEmployeeDetailsFromLinkedin = (req, res) => {
  const body = req.body;
  candidateManager
    .getLinkedinEmployeeLoginDetails(body)
    .then((response: any) => sendResponse(res, response.code, 1, 200, response.message, response.data))
    .catch((error: any) => sendResponse(res, error.code, 0, 400, error.message, error.data));
};
...
export const modifyProviderCandidateDetails = (req, res) => {
  const body = req.body;
  candidateManager
    .updateProviderCandidateInfo(body)
    .then((response: any) => sendResponse(res, response.code, 1, 200, response.message, response.data))
    .catch((error: any) => sendResponse(res, error.code, 0, 400, error.message, error.data));
};
...
export const providerCandidateDetails = (req, res) => {
  const body = req.query;
  candidateManager
    .getProviderCandidateResume(body)
    .then((response: any) => sendResponse(res, response.code, 1, 201, response.message, response.data))
    .catch((error: any) => sendResponse(res, error.code, 0, 401, error.message, error.data));
};
...
export const updateProviderCandidateEllowRateController = (req, res) => {
  const body = req.body;
  candidateManager
    .addProviderCandidateEllowRate(body)
    .then((response: any) => sendResponse(res, response.code, 1, 201, response.message, response.data))
    .catch((error: any) => sendResponse(res, error.code, 0, 401, error.message, error.data));
};
export const approveProviderCandidates = (req, res) => {
  const body = req.body;
  candidateManager
    .approveProvidersCandidates(body)
    .then((response: any) => sendResponse(res, response.code, 1, 201, response.message, response.data))
    .catch((error: any) => sendResponse(res, error.code, 0, 401, error.message, error.data));
};
...
export const requestForScreeningController = (req, res) => {
  const body = req.query;
  candidateManager
    .requestForScreeningManager(body)
    .then((response: any) => {
      sendResponse(res, response.code, 1, 201, response.message, response.data);
    })
    .catch((error) => {
...
export const sentFreelancerLoginCredentialsController = (req, res) => {
  const body = req.body;
  candidateManager
    .sentFreelancerLoginCredentials(body)
    .then((response: any) => {
      sendResponse(res, response.code, 1, 201, response.message, response.data);
    })
    .catch((error) => {
...
export const approveOrRejectAppliedCandidateController = (req, res) => {
  const body = req.body;
  candidateManager
    .approveOrRejectAppliedCandidate(body)
    .then((response: any) => {
      sendResponse(res, response.code, 1, 201, response.message, response.data);
    })
    .catch((error) => {
...
export const sendblueAddCertifiedContact = (req, res) => {
  const body = req.body;
  candidateManager
    .devSendinblueCertifiedList(body)
    .then((response: any) => {
      sendResponse(res, response.code, 1, 201, response.message, response.data);
    })
    .catch((error) => {
...
export const fullProfileResumeParserController = (req, res) => {
  const body = req.body;
  candidateManager
    .fullProfileResumeParser(body)
    .then((response: any) => sendResponse(res, response.code, 1, 200, response.message, response.data))
    .catch((error: any) => sendResponse(res, error.code, 0, 400, error.message, error.data));
};

export const addReferralController = (req, res) => {
  const body = req.body;
  candidateManager
    .addReferral(body)
    .then((response: any) => sendResponse(res, response.code, 1, 200, response.message, response.data))
...
export const getEmailAddressFromReferralTokenController = (req, res) => {
  const body = req.body;
  candidateManager
    .getEmailAddressFromReferralToken(body)
    .then((response: any) => sendResponse(res, response.code, 1, 200, response.message, response.data))
    .catch((error: any) => sendResponse(res, error.code, 0, 400, error.message, error.data));
};


export const candidateAdminReferralListController = (req, res) => {
  const body = req.query;
  candidateManager

...
export const languageProficiencySchema = Joi.object()
  .keys({
    action: Joi.string()
      .required()
    ...
    candidateId: Joi.number().when('action', {
      is: ['add', 'update'],
      then: Joi.number()
        .required()
        .error((errors) => {
    ...
    candidateLanguageId: Joi.number().when('action', {
      is: ['update', 'delete'],
      then: Joi.number()
        .required()
        .error((errors) => {
...
export const projectSchema = Joi.object()
  .keys({
    ...
    candidateProjectId: Joi.number().when('action', {
      is: ['update', 'delete'],
      then: Joi.number()
        .required()
        .error((errors) => {
...
export const profileDetailSchema = Joi.object()
  .keys({
    candidateId: Joi.number()
      .required()
      .error((errors) => {
...
export const workExperienceSchema = Joi.object()
  .keys({
    ...
    candidateWorkExperienceId: Joi.number().when('action', {
      is: ['update', 'delete'],
      then: Joi.number()
        .required()
        .error((errors) => {
...
export const educationSchema = Joi.object()
  .keys({
    ...
    candidateEducationId: Joi.number().when('action', {
      is: ['update', 'delete'],
      then: Joi.number()
        .required()
        .error((errors) => {
...
export const awardSchema = Joi.object()
  .keys({
    ...
    candidateAwardId: Joi.number().when('action', {
      is: ['update', 'delete'],
      then: Joi.number()
        .required()
        .error((errors) => {
...
export const skillSchema = Joi.object()
  .keys({
    ...
    candidateSkillId: Joi.number().when('action', {
      is: ['update', 'delete'],
      then: Joi.number()
        .required()
        .error((errors) => {
...
export const publicationSchema = Joi.object()
  .keys({
    ...
    candidatePublicationId: Joi.number().when('action', {
      is: ['update', 'delete'],
      then: Joi.number()
        .required()
        .error((errors) => {

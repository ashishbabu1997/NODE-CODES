...
/**
 * @swagger
 * /candidates/listIncontractResources:
 *   post:
 *     tags:
 *       - Candidates
 *     name: List incontract candidates
 *     summary: list reources who are incontract or have completed a contract
 *     description: Filters <br><br> resourcesType - [ "Vetted Resources" / "Non-Vetted Resources" ] <br> skills - [ "Axios" , "Material-UI" ... ] <br> locations - ["Kochi, Kerala, India","Mahipalpur, New Delhi, Delhi, India"] <br> positionStatus - [ "Resource accepted offer" , "Make offer" ] <br> candidateStatus - [ "Vetted", "Rejected" , "Profile Screening Scheduled" ]
 *     consumes:
 *       - application/json
 *     security:
 ...
 *         schema:
 *         type: string
 *         enum: [activeIncontract,closedIncontract]
 *       - in: query
 *         name: filter
 *         schema:
 *         type: string
 ...
 *     summary: Update contract details for a candidate who has in contract for a position
 *     security:
 *       - bearerAuth: []
 *     consumes:
 *       - application/json

  ...
  switch (body.tabValue) {
    ...
    case 'provider':
      ...
      case 'activeIncontract':
          query = '  where chsv."candidateStatus"=3 and chsv."pStatus"=true and chsv."blacklisted"=false and chsv."makeOffer"=0 where extract((epoch from now()))*1000<(select contract_end_date from candidate_contract_details where candidate_id=chsv."candidateId" and position_id=chsv."positionId") ';
          break;

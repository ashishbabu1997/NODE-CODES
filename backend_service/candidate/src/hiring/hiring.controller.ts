...
export const getAllCandidateHiringSteps = (req, res) => {
  const body = req.query;
  hiringManager
    .getAllCandidateHiringSteps(body)
    .then((response: any) => {
      sendResponse(res, response.code, 1, 201, response.message, response.data);
    })
    .catch((error) => {
...
export const reorderCandidateHiringSteps = (req, res) => {
  const body = req.body;
  hiringManager
    .reorderHiringSteps(body)
    .then((response: any) => {
      sendResponse(res, response.code, 1, 201, response.message, response.data);
    })
    .catch((error) => {

export default {
    ...
    createNotification: `INSERT into notifications (position_id ,candidate_id, message, company_id, notification_type,created_on, updated_on,user_role_id,created_by,image,first_name,last_name ) values ($1, $2, $3, $4,$5, $6, $6, $7,$8,$9,$10,$11)`,
